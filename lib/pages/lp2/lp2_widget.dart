...
import 'lp2_model.dart';
export 'lp2_model.dart';

class Lp2Widget extends StatefulWidget {
  const Lp2Widget({super.key});

  @override
  State<Lp2Widget> createState() => _Lp2WidgetState();
}

class _Lp2WidgetState extends State<Lp2Widget> {
  late Lp2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Lp2Model());
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: const AlignmentDirectional(-1.11, -2.38),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8.0),
                  child: SvgPicture.asset(
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: SvgPicture.asset(
                          'assets/images/Progress_bar_(2).svg',
                          width: 184.0,
                          height: 14.0,
                          fit: BoxFit.contain,
                        ),
