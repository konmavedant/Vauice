...
import 'chat2_mentor_model.dart';
export 'chat2_mentor_model.dart';

class Chat2MentorWidget extends StatefulWidget {
  const Chat2MentorWidget({super.key});

  @override
  State<Chat2MentorWidget> createState() => _Chat2MentorWidgetState();
}

class _Chat2MentorWidgetState extends State<Chat2MentorWidget> {
  late Chat2MentorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chat2MentorModel());
