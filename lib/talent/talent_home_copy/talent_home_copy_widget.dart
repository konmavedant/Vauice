...
import '/talent/usercomment/usercomment_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'talent_home_copy_model.dart';
export 'talent_home_copy_model.dart';

class TalentHomeCopyWidget extends StatefulWidget {
  const TalentHomeCopyWidget({
    super.key,
    this.post,
  });
  ...
  @override
  State<TalentHomeCopyWidget> createState() => _TalentHomeCopyWidgetState();
}

class _TalentHomeCopyWidgetState extends State<TalentHomeCopyWidget> {
  late TalentHomeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TalentHomeCopyModel());
                                                ...
                                                image: DecorationImage(
                                                  ...
                                                  image: Image.network(
                                                    valueOrDefault<String>(
                                                      listViewPostRecord
                                                          .uploadImg,
                                                      'https://images.unsplash.com/photo-1624526267942-ab0ff8a3e972?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxNXx8Y3JpY2tldHxlbnwwfHx8fDE3MTk4MDIyMDF8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                    ),
                                                  ).image,
                                                ),
                                                boxShadow: const [
